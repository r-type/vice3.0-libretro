...
void Draw_text(unsigned short *buffer, int x, int y, unsigned short fgcol, unsigned short int bgcol, libretro_graph_alpha_t alpha, bool draw_bg, int scalex, int scaley, int max, signed char *string, ...);
void Draw_text32(uint32_t *buffer, int x, int y, uint32_t fgcol, uint32_t bgcol, libretro_graph_alpha_t alpha, bool draw_bg, int scalex, int scaley, int max, signed char *string, ...);
