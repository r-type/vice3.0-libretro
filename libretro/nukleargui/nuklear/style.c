enum theme {THEME_BLACK, THEME_WHITE, THEME_RED, THEME_BLUE, THEME_DARK, THEME_C64, THEME_C64C, THEME_TRANSPARENT, THEME_C64_TRANSPARENT, THEME_C64C_TRANSPARENT};
...
set_style(struct nk_context *ctx, enum theme theme)
{
    ...
    if (theme == THEME_WHITE) {
        ...
        table[NK_COLOR_BORDER] = nk_rgba(0, 0, 0, 1); 
        table[NK_COLOR_BUTTON] = nk_rgba(255, 255, 255, 20); // regular keys
